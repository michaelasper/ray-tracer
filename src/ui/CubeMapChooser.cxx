...
void CubeMapChooser::show() { w->show(); }

void CubeMapChooser::hide() { w->hide(); }
...
void CubeMapChooser::cb_ok(Fl_Widget* o, void* v) {
    ...
    if (allGreen) {
        ...
        for (int i = 0; i < 6; i++) cm->setNthMap(i, ch->cubeFace[i].release());
...
void CubeMapChooser::cb_xpi(Fl_Widget* o, void* v) { cb_ffi(o, 0); }

void CubeMapChooser::cb_xpb(Fl_Widget* o, void* v) { cb_ffb(o, 0); }

void CubeMapChooser::cb_xni(Fl_Widget* o, void* v) { cb_ffi(o, 1); }

void CubeMapChooser::cb_xnb(Fl_Widget* o, void* v) { cb_ffb(o, 1); }

void CubeMapChooser::cb_ypi(Fl_Widget* o, void* v) { cb_ffi(o, 2); }

void CubeMapChooser::cb_ypb(Fl_Widget* o, void* v) { cb_ffb(o, 2); }

void CubeMapChooser::cb_yni(Fl_Widget* o, void* v) { cb_ffi(o, 3); }

void CubeMapChooser::cb_ynb(Fl_Widget* o, void* v) { cb_ffb(o, 3); }

void CubeMapChooser::cb_zpi(Fl_Widget* o, void* v) { cb_ffi(o, 4); }

void CubeMapChooser::cb_zpb(Fl_Widget* o, void* v) { cb_ffb(o, 4); }

void CubeMapChooser::cb_zni(Fl_Widget* o, void* v) { cb_ffi(o, 5); }

void CubeMapChooser::cb_znb(Fl_Widget* o, void* v) { cb_ffb(o, 5); }
...
void CubeMapChooser::cb_ffb(Fl_Widget* o, int i) {
    CubeMapChooser* ch = (CubeMapChooser*)(o->parent()->user_data());
    char* curPath =
        fl_file_chooser(ch->btnMsg[i].c_str(), ".bmp or .png (*.{bmp,png})",
                        ch->fn[i].c_str(), 0);
    if (curPath) {
        ch->fb[i]->value(0);
        if (!ch->smartLoad || !ch->loadAll(curPath)) {
             ...
             */
            if (!ch->loadImageInto(curPath, i)) return;
        }
    }
    ch->fb[i]->value(1);
}
